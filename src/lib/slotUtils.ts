...
// dateKey = "YYYY-MM-DD" — uses local time to stay in sync with date-fns
// (eachDayOfInterval resets hours to local midnight; toISOString would give
// the previous UTC date for timezones ahead of UTC, shifting the calendar by 1 day)
